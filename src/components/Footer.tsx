      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          <div className="col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold">Pixcelvane</span>
            </Link>
            <p className="text-white/60 mb-6 max-w-xs">
              Unlimited design services. One subscription. Transform your brand with stunning visuals.
            </p>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/40 text-sm">
            © {new Date().getFullYear()} Pixcelvane. All rights reserved.
          </p>
          <p className="text-white/40 text-sm">
            Made with ❤️ for creative businesses worldwide
          </p>
        </div>
      </div>
    </footer>
